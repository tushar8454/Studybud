...
SECRET_KEY = 'django-insecure-^b#@hmbgeev6f54_u7sv0yhukn=kvw8=q@cq0y=yg$0di5d@dh'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            # here we can register directory
            BASE_DIR / 'templates',
...
#HERE it means user can upload a image in website
STATIC_ROOT=[]
